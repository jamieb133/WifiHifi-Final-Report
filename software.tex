...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.4, every node/.style={scale=1}]
        \begin{umlpackage}[fill=creamy]{WifiHifi Client}
            ...
            \umlsimpleclass[x=0,y=2*\yval, scale=\scaleuml, type=class]{IIRFilter}
            \umlsimpleclass[x=0,y=3*\yval, scale=\scaleuml, type=class]{FIRFilter}
            \umlsimpleclass[x=1.5*\xval,y=3*\yval, scale=\scaleuml, type=class]{Fir1}
